...
static const char* _0RL_enumMember_Img_mColorFormat[] = { "CF_UNKNOWN", "CF_GRAY", "CF_RGB", "CF_JPEG", "CF_PNG", "RGB", "RLE8", "RLE", "RAW", "RGBA", "RGBT", "AYUV", "CLJR", "CYUV", "GREY", "IRAW", "IUYV", "IY41", "IYU1", "IYU2", "HDYC", "UYNV", "UYVP", "V210", "V422", "V655", "VYUV", "YUNV", "YVYU", "Y41P", "Y211", "Y41T", "Y42T", "YUVP", "Y800", "Y8", "Y16" };
...
static CORBA::PR_structMember _0RL_structmember_Img_mNamedValue[] = {
  {"name", CORBA::TypeCode::PR_string_tc(0, &_0RL_tcTrack)},
  {"value", CORBA::TypeCode::PR_string_tc(0, &_0RL_tcTrack)}
};

#ifdef _0RL_tc_Img_mNamedValue
#  undef _0RL_tc_Img_mNamedValue
#endif
static CORBA::TypeCode_ptr _0RL_tc_Img_mNamedValue = CORBA::TypeCode::PR_struct_tc("IDL:Img/NamedValue:1.0", "NamedValue", _0RL_structmember_Img_mNamedValue, 2, &_0RL_tcTrack);

#if defined(HAS_Cplusplus_Namespace) && defined(_MSC_VER)
// MSVC++ does not give the constant external linkage otherwise.
namespace Img { 
  const ::CORBA::TypeCode_ptr _tc_NamedValue = _0RL_tc_Img_mNamedValue;
} 
#else
const ::CORBA::TypeCode_ptr Img::_tc_NamedValue = _0RL_tc_Img_mNamedValue;
#endif
...
static CORBA::TypeCode_ptr _0RL_tc_Img_mNVList = CORBA::TypeCode::PR_alias_tc("IDL:Img/NVList:1.0", "NVList", CORBA::TypeCode::PR_sequence_tc(0, _0RL_tc_Img_mNamedValue, &_0RL_tcTrack), &_0RL_tcTrack);


#if defined(HAS_Cplusplus_Namespace) && defined(_MSC_VER)
// MSVC++ does not give the constant external linkage otherwise.
namespace Img { 
  const ::CORBA::TypeCode_ptr _tc_NVList = _0RL_tc_Img_mNVList;
} 
#else
const ::CORBA::TypeCode_ptr Img::_tc_NVList = _0RL_tc_Img_mNVList;
#endif



static CORBA::PR_structMember _0RL_structmember_Img_mCameraDeviceProfile[] = {
  {"devtypeid", CORBA::TypeCode::PR_string_tc(0, &_0RL_tcTrack)},
  {"guid", CORBA::TypeCode::PR_string_tc(0, &_0RL_tcTrack)},
  {"unit", CORBA::TypeCode::PR_short_tc()},
  {"vendor_name", CORBA::TypeCode::PR_string_tc(0, &_0RL_tcTrack)},
  {"model_name", CORBA::TypeCode::PR_string_tc(0, &_0RL_tcTrack)},
  {"intrinsic", _0RL_tc_Img_mCameraIntrinsicParameter},
  {"properties", _0RL_tc_Img_mNVList}
};

#ifdef _0RL_tc_Img_mCameraDeviceProfile
#  undef _0RL_tc_Img_mCameraDeviceProfile
#endif
static CORBA::TypeCode_ptr _0RL_tc_Img_mCameraDeviceProfile = CORBA::TypeCode::PR_struct_tc("IDL:Img/CameraDeviceProfile:1.0", "CameraDeviceProfile", _0RL_structmember_Img_mCameraDeviceProfile, 7, &_0RL_tcTrack);
...
// MSVC++ does not give the constant external linkage otherwise.
namespace Img { 
  const ::CORBA::TypeCode_ptr _tc_CameraDeviceProfile = _0RL_tc_Img_mCameraDeviceProfile;
} 
#else
const ::CORBA::TypeCode_ptr Img::_tc_CameraDeviceProfile = _0RL_tc_Img_mCameraDeviceProfile;
#endif
...
static void _0RL_Img_mNamedValue_marshal_fn(cdrStream& _s, void* _v)
{
  Img::NamedValue* _p = (Img::NamedValue*)_v;
  *_p >>= _s;
}
static void _0RL_Img_mNamedValue_unmarshal_fn(cdrStream& _s, void*& _v)
{
  Img::NamedValue* _p = new Img::NamedValue;
  *_p <<= _s;
  _v = _p;
}
static void _0RL_Img_mNamedValue_destructor_fn(void* _v)
{
  Img::NamedValue* _p = (Img::NamedValue*)_v;
  delete _p;
}

void operator<<=(::CORBA::Any& _a, const Img::NamedValue& _s)
{
  Img::NamedValue* _p = new Img::NamedValue(_s);
  _a.PR_insert(_0RL_tc_Img_mNamedValue,
               _0RL_Img_mNamedValue_marshal_fn,
               _0RL_Img_mNamedValue_destructor_fn,
               _p);
}
void operator<<=(::CORBA::Any& _a, Img::NamedValue* _sp)
{
  _a.PR_insert(_0RL_tc_Img_mNamedValue,
               _0RL_Img_mNamedValue_marshal_fn,
               _0RL_Img_mNamedValue_destructor_fn,
...
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, Img::NamedValue*& _sp)
{
  return _a >>= (const Img::NamedValue*&) _sp;
}
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, const Img::NamedValue*& _sp)
{
  void* _v;
  if (_a.PR_extract(_0RL_tc_Img_mNamedValue,
                    _0RL_Img_mNamedValue_unmarshal_fn,
                    _0RL_Img_mNamedValue_marshal_fn,
                    _0RL_Img_mNamedValue_destructor_fn,
                    _v)) {
    _sp = (const Img::NamedValue*)_v;
    return 1;
  }
  return 0;
}

static void _0RL_Img_mNVList_marshal_fn(cdrStream& _s, void* _v)
{
  Img::NVList* _p = (Img::NVList*)_v;
  *_p >>= _s;
}
static void _0RL_Img_mNVList_unmarshal_fn(cdrStream& _s, void*& _v)
{
  Img::NVList* _p = new Img::NVList;
  *_p <<= _s;
  _v = _p;
}
static void _0RL_Img_mNVList_destructor_fn(void* _v)
{
  Img::NVList* _p = (Img::NVList*)_v;
  delete _p;
}
...
{
  Img::NVList* _p = new Img::NVList(_s);
  _a.PR_insert(_0RL_tc_Img_mNVList,
               _0RL_Img_mNVList_marshal_fn,
               _0RL_Img_mNVList_destructor_fn,
               _p);
}
...
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, Img::NVList*& _sp)
{
  return _a >>= (const Img::NVList*&) _sp;
}
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, const Img::NVList*& _sp)
{
  void* _v;
  if (_a.PR_extract(_0RL_tc_Img_mNVList,
                    _0RL_Img_mNVList_unmarshal_fn,
                    _0RL_Img_mNVList_marshal_fn,
                    _0RL_Img_mNVList_destructor_fn,
                    _v)) {
    _sp = (const Img::NVList*)_v;
    return 1;
  }
  return 0;
}

static void _0RL_Img_mCameraDeviceProfile_marshal_fn(cdrStream& _s, void* _v)
{
  Img::CameraDeviceProfile* _p = (Img::CameraDeviceProfile*)_v;
  *_p >>= _s;
}
static void _0RL_Img_mCameraDeviceProfile_unmarshal_fn(cdrStream& _s, void*& _v)
{
  Img::CameraDeviceProfile* _p = new Img::CameraDeviceProfile;
  *_p <<= _s;
  _v = _p;
}
static void _0RL_Img_mCameraDeviceProfile_destructor_fn(void* _v)
{
  Img::CameraDeviceProfile* _p = (Img::CameraDeviceProfile*)_v;
  delete _p;
}

void operator<<=(::CORBA::Any& _a, const Img::CameraDeviceProfile& _s)
{
  Img::CameraDeviceProfile* _p = new Img::CameraDeviceProfile(_s);
  _a.PR_insert(_0RL_tc_Img_mCameraDeviceProfile,
               _0RL_Img_mCameraDeviceProfile_marshal_fn,
               _0RL_Img_mCameraDeviceProfile_destructor_fn,
               _p);
}
void operator<<=(::CORBA::Any& _a, Img::CameraDeviceProfile* _sp)
{
  _a.PR_insert(_0RL_tc_Img_mCameraDeviceProfile,
               _0RL_Img_mCameraDeviceProfile_marshal_fn,
               _0RL_Img_mCameraDeviceProfile_destructor_fn,
...
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, Img::CameraDeviceProfile*& _sp)
{
  return _a >>= (const Img::CameraDeviceProfile*&) _sp;
}
::CORBA::Boolean operator>>=(const ::CORBA::Any& _a, const Img::CameraDeviceProfile*& _sp)
{
  void* _v;
  if (_a.PR_extract(_0RL_tc_Img_mCameraDeviceProfile,
                    _0RL_Img_mCameraDeviceProfile_unmarshal_fn,
                    _0RL_Img_mCameraDeviceProfile_marshal_fn,
                    _0RL_Img_mCameraDeviceProfile_destructor_fn,
                    _v)) {
    _sp = (const Img::CameraDeviceProfile*)_v;
    return 1;
  }
  return 0;
}
