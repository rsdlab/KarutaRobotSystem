...
void
Img::NamedValue::operator>>= (cdrStream &_n) const
{
...
void
Img::NamedValue::operator<<= (cdrStream &_n)
{
...
void
Img::CameraDeviceProfile::operator>>= (cdrStream &_n) const
{
  _n.marshalString(devtypeid,0);
  _n.marshalString(guid,0);
  unit >>= _n;
  _n.marshalString(vendor_name,0);
  _n.marshalString(model_name,0);
  (const CameraIntrinsicParameter&) intrinsic >>= _n;
...
void
Img::CameraDeviceProfile::operator<<= (cdrStream &_n)
{
  devtypeid = _n.unmarshalString(0);
  guid = _n.unmarshalString(0);
  (::CORBA::Short&)unit <<= _n;
  vendor_name = _n.unmarshalString(0);
  model_name = _n.unmarshalString(0);
  (CameraIntrinsicParameter&)intrinsic <<= _n;
...
// Proxy call descriptor class. Mangled signature:
//  _wvoid_i_clong
class _0RL_cd_5af2d202b3c2d8b9_20000000
  : public omniCallDescriptor
{
public:
  inline _0RL_cd_5af2d202b3c2d8b9_20000000(LocalCallFn lcfn,const char* op_,size_t oplen,_CORBA_Boolean upcall=0):
     omniCallDescriptor(lcfn, op_, oplen, 1, _user_exns, 0, upcall)
  {
...
void _0RL_cd_5af2d202b3c2d8b9_20000000::marshalArguments(cdrStream& _n)
{
  arg_0 >>= _n;

}

void _0RL_cd_5af2d202b3c2d8b9_20000000::unmarshalArguments(cdrStream& _n)
{
  (::CORBA::Long&)arg_0 <<= _n;

}

const char* const _0RL_cd_5af2d202b3c2d8b9_20000000::_user_exns[] = {
  0
};

// Local call call-back function.
static void
_0RL_lcfn_5af2d202b3c2d8b9_30000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_5af2d202b3c2d8b9_20000000* tcd = (_0RL_cd_5af2d202b3c2d8b9_20000000*)cd;
  Img::_impl_CameraCaptureService* impl = (Img::_impl_CameraCaptureService*) svnt->_ptrToInterface(Img::CameraCaptureService::_PD_repoId);
  impl->take_multi_frames(tcd->arg_0);


}

void Img::_objref_CameraCaptureService::take_multi_frames(::CORBA::Long num)
{
  _0RL_cd_5af2d202b3c2d8b9_20000000 _call_desc(_0RL_lcfn_5af2d202b3c2d8b9_30000000, "take_multi_frames", 18);
...
// Local call call-back function.
static void
_0RL_lcfn_5af2d202b3c2d8b9_40000000(omniCallDescriptor*, omniServant* svnt)
{
...
{
  _0RL_cd_5af2d202b3c2d8b9_00000000 _call_desc(_0RL_lcfn_5af2d202b3c2d8b9_40000000, "start_continuous", 17);
...
// Local call call-back function.
static void
_0RL_lcfn_5af2d202b3c2d8b9_50000000(omniCallDescriptor*, omniServant* svnt)
{
...
{
  _0RL_cd_5af2d202b3c2d8b9_00000000 _call_desc(_0RL_lcfn_5af2d202b3c2d8b9_50000000, "stop_continuous", 16);
...
// Proxy call descriptor class. Mangled signature:
//  void_o_cImg_mCameraDeviceProfile
class _0RL_cd_5af2d202b3c2d8b9_60000000
  : public omniCallDescriptor
{
public:
  inline _0RL_cd_5af2d202b3c2d8b9_60000000(LocalCallFn lcfn,const char* op_,size_t oplen,_CORBA_Boolean upcall=0):
  ...
  Img::CameraDeviceProfile_var arg_0;
};

void _0RL_cd_5af2d202b3c2d8b9_60000000::marshalReturnedValues(cdrStream& _n)
{
  (const Img::CameraDeviceProfile&) arg_0 >>= _n;

}

void _0RL_cd_5af2d202b3c2d8b9_60000000::unmarshalReturnedValues(cdrStream& _n)
{
  arg_0 = new Img::CameraDeviceProfile;
  (Img::CameraDeviceProfile&)arg_0 <<= _n;

}

const char* const _0RL_cd_5af2d202b3c2d8b9_60000000::_user_exns[] = {
  0
};

// Local call call-back function.
static void
_0RL_lcfn_5af2d202b3c2d8b9_70000000(omniCallDescriptor* cd, omniServant* svnt)
{
  _0RL_cd_5af2d202b3c2d8b9_60000000* tcd = (_0RL_cd_5af2d202b3c2d8b9_60000000*)cd;
  Img::_impl_CameraCaptureService* impl = (Img::_impl_CameraCaptureService*) svnt->_ptrToInterface(Img::CameraCaptureService::_PD_repoId);
  impl->getProfile(tcd->arg_0.out());


}

void Img::_objref_CameraCaptureService::getProfile(::Img::CameraDeviceProfile_out profile)
{
  _0RL_cd_5af2d202b3c2d8b9_60000000 _call_desc(_0RL_lcfn_5af2d202b3c2d8b9_70000000, "getProfile", 11);


  _invoke(_call_desc);
  profile = _call_desc.arg_0._retn();
...
Img::_impl_CameraCaptureService::_dispatch(omniCallHandle& _handle)
{
  ...
  if( omni::strMatch(op, "take_multi_frames") ) {

    _0RL_cd_5af2d202b3c2d8b9_20000000 _call_desc(_0RL_lcfn_5af2d202b3c2d8b9_30000000, "take_multi_frames", 18, 1);
  ...
  if( omni::strMatch(op, "start_continuous") ) {
    ...
    _0RL_cd_5af2d202b3c2d8b9_00000000 _call_desc(_0RL_lcfn_5af2d202b3c2d8b9_40000000, "start_continuous", 17, 1);
  ...
  if( omni::strMatch(op, "stop_continuous") ) {
    ...
    _0RL_cd_5af2d202b3c2d8b9_00000000 _call_desc(_0RL_lcfn_5af2d202b3c2d8b9_50000000, "stop_continuous", 16, 1);
  ...
  if( omni::strMatch(op, "getProfile") ) {
    ...
    _0RL_cd_5af2d202b3c2d8b9_60000000 _call_desc(_0RL_lcfn_5af2d202b3c2d8b9_70000000, "getProfile", 11, 1);
